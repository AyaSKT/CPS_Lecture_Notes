...
#### DSB-WC Modulation
$$\varphi_{AM}(t) = [A + m(t)] \cos{(2 \pi f_c t)}$$.![[Pasted image 20251120143359.png]]
其频谱与DSB-SC基本一致，但在$\pm f_c$处有两个额外的冲激响应。
$$[A+m(t)] \cos (2 \pi f_c t) \Leftrightarrow \frac{1}{2}[M(f+f_c)+M(f-f_c)]+\frac{A}{2}[\delta(f+f_c)+\delta(f-f_c)]$$.![[Pasted image 20251120143706.png]]
#### DSB-WC的缺点
...
![[Pasted image 20251120145341.png]]
...
$$\mu = \frac{m_p}{A_c}$$
![[Pasted image 20251120145953.png]]
...
![[Pasted image 20251120152711.png]]
...
![[Pasted image 20251120153109.png]]
整流后的信号可表示为：
$$
